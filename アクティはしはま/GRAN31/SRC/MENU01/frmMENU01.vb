...
#Region "▼宣言部"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _blnMltDispFlg As Boolean = False
        ...
        Try
            ...
            Try
                If UIUtility.SYSTEM.SYSTEMKBN.Equals(0) Then
                    ...
                    Me.lblBackUpTime.Text = "バックアップ時間:" & System.IO.File.GetLastWriteTime("D:\BackUp\ACTY.DMP").ToString
                Else
                    Me.lblBackUpTime.Visible = False
                End If
            Catch ex As Exception
    ...
    Private Sub frmMENU01_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        Try
            ...
            If UIUtility.SYSTEM.SYSTEMKBN.Equals(0) Then
                Try
                    _prcSEATSERVER.Kill()
                    If Screen.AllScreens.Length > 1 Or _blnMltDispFlg Then
                        If UIUtility.SYSTEM.DISPMULTI.Equals(1) Then
                            _process.Kill()
                        End If
                    End If
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        Try
            ...
            If UIUtility.SYSTEM.SYSTEMKBN.Equals(0) Then
                ...
                Try
                    If UIUtility.SYSTEM.DISPMULTI.Equals(1) Then
                        '何かの影響でマルチディスプレイでなくなったとき
                        If Screen.AllScreens.Length.Equals(1) And _blnMltDispFlg Then
                            If UIUtility.SYSTEM.DISPMULTI.Equals(1) Then
                                _process.Kill()
                                _blnMltDispFlg = False
                            End If
                        End If

                        '起動中マルチディスプレイになった時
                        If Screen.AllScreens.Length > 1 And Not _blnMltDispFlg Then
                            If UIUtility.SYSTEM.DISPMULTI.Equals(1) Then
                                Dim scr As Screen
                                For Each i In Screen.AllScreens
                                    If Not i.Primary Then
...
#Region "▼帳票ボタン関連"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub btnPRINT17_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPRINT17.Click
        Try
            Using frm As New frmPRINT17(iDatabase)
                frm.ShowDialog()
            End Using
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub btnPRINT16_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPRINT16.Click
        Try
            Using frm As New frmPRINT16(iDatabase)
                frm.ShowDialog()
            End Using
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub btnPRINT15_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPRINT15.Click
        Try
            Using frm As New frmPRINT15(iDatabase)
                frm.ShowDialog()
            End Using
    ...
    Private Function InsCALMTA() As Boolean
        Try
            ...
            Else
                ...
                If intYoubi.Equals(1) Or intYoubi.Equals(7) Then
                    sql.Append(",2," & intYoubi & ",NULL,NULL,NOW(),NOW())")
                Else
                    sql.Append(",1," & intYoubi & ",NULL,NULL,NOW(),NOW())")
                End If
