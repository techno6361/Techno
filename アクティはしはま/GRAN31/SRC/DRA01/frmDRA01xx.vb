    ...
    Private Sub GetURIAGE()
        ...
        Try
            ...
            For Each row As DataGridViewRow In Me.dgvDRATRN.Rows
                ...
                End If
                row.DefaultCellStyle.Font = New Font("ＭＳ ゴシック", 14.25, FontStyle.Bold)
            Next
    ...
    Private Function getMANNM(ByVal manno As String, ByVal sclmanno As String) As String
        ...
        Try
            ...
            If Not String.IsNullOrEmpty(manno) Then
                ...
                Dim query = csDt.AsEnumerable.Where(Function(x As DataRow) x("NCSNO").Equals(ncsno))
            ...
            If Not String.IsNullOrEmpty(sclmanno) Then
                Dim query = manDt.AsEnumerable.Where(Function(x As DataRow) x("SCLMANNO").Equals(sclmanno))
                If query.Count > 0 Then
