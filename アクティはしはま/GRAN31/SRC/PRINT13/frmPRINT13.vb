...
#Region "▼宣言部"
    ...
    ' OPEN/SAVEファイル
    Const REPORT_NAME = "領収書発行履歴一覧"

    ' フォーム名
    Const FORM_NAME = "領収書発行履歴一覧"
...
#Region "▼イベント定義"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub frmPRINT13_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            '画面初期設定
            Init()
    ...
    Private Sub btnFIND_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFIND.Click
        Try
            ...
            If Not GetRCTTRN(date1, date2) Then
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub frmPRINT13_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
...
#Region "▼関数定義"
        ...
        Try
            ...
            For Each day_rows In group_list
                ...
                For Each row In day_rows
                    ...
                    ' 伝票番号
                    excel.Cells(row_index, 4) = row.RCTNO

                    ' 宛名
                    excel.Cells(row_index, 5) = row.ATENA

                    ' 金額
                    excel.Cells(row_index, 6) = row.KINGAKU.ToString("N0")

                    ' 但
                    excel.Cells(row_index, 7) = row.TADASHI
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function GetRCTTRN(ByVal date1 As String, ByVal date2 As String) As Boolean
        ...
        Try
            ...
            sql.Append(String.Format(" AND RCTDT >= '{0}'", date1))
            sql.Append(String.Format(" AND RCTDT <= '{0}'", date2))
            ...
            Dim query = From x In dt.AsEnumerable
                        Select New RECARDTRN_View With {
                            ...
                            .RCTNO = x("RCTNO").ToString.PadLeft(4, "0"c),
                            .ATENA = x("ATENA").ToString,
                            .KINGAKU = CType(x("KINGAKU").ToString, Integer),
                            .TADASHI = x("TADASHI").ToString,
            ...
            For Each row In query
                ...
                data.RCTNO = row.RCTNO
                data.ATENA = row.ATENA
                data.KINGAKU = row.KINGAKU
                data.TADASHI = row.TADASHI
