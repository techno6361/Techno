...
#Region "▼イベント定義"
    ...
    Private Sub frmMenu01_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Shown
        Try
            ...
            'ｺｲﾝﾒｯｸCOMポート名
            UIUtility.SYSTEM.CMCOM = Configuration.ConfigurationManager.AppSettings("CM_COM")
            'レシートプリンターポート名
            ...
            If UIUtility.SYSTEM.SYSTEMKBN.Equals(0) Then
                ...
                If Me.btnCharge.Visible Then
                    ...
                    Else
                        '【接続エラー】
                        Me.lblPrinterError.Visible = True
                    End If
                    ...
                    If _dcAD1.Connect Then
                        ...
                        End If
                        '機能ﾁｪｯｸ
                        If _dcAD1.Check_Command(20) Then
                            blnAD1 = True
                        Else
                    ...
                    If _dcCM.Reset Then
                        '接続があるか確認
                        If Not _dcCM.ConnectionCheck.Equals("1") Then
                            Me.lblCMError.Visible = True
                        End If
                        For i As Integer = 1 To 7
                            CheckCM()
                            If Not Me.lblCMError.Visible Then
                                Exit For
                            Else
                                Thread.Sleep(200)
                            End If
            ...
            If Me.lblAd1Error.Visible Or Me.lblRWError.Visible Then
                'If Me.lblChangeError.Visible Or Me.lblAd1Error.Visible Or Me.lblRWError.Visible Then
                    ...
                    If UIUtility.SYSTEM.SYSTEMKBN.Equals(0) Then
                        ...
                        If _strFunction.Substring(2, 1).Equals("1") Then
                            ...
                            For i As Integer = 1 To 3
                                'エラー確認
                                CheckPrinter()
                                If Not Me.lblPrinterError.Visible Then
                                    Exit For
                                End If
                                Thread.Sleep(50)
                            Next
    ...
    Private Sub btnCheckIn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCheckIn.Click
        ...
        Try
            ...
            Using frm As New frmPlaySelect01()
                frm.iDatabase = _iDatabase
                frm.ICR700 = _dcICR700
                frm.BallKin1F = _intBALLKIN1F
                frm.BallKin2F = _intBALLKIN2F
    ...
    Private Sub btnCharge_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCharge.Click
        ...
        Try
            ...
            'レスポンスパラメーター
            Select Case _dcAD1.RspParameter
                Case 8 '機能チェックコマンド受信前
                    '機能ﾁｪｯｸ
                    If _dcAD1.Check_Command(20) Then
                    End If
            End Select
...
#End If
    ...
    Private Function InsREPOCHARGE_M() As Boolean
        ...
        Try
            ...
            Dim dtNKNMST As DataTable = _iDatabase.ExecuteRead(sql.ToString())
            ...
            If resultDt.Rows.Count.Equals(0) Then
                ...
                '入金ボタン１金額
                strSQL01 &= "CHARGE1KIN,"
                dr = dtNKNMST.Select("SEQNO = 1")
                If dr.Length > 0 Then
                    strSQL02 &= dr(0).Item("NKNKN").ToString & ","
                Else
                    strSQL02 &= "0,"
                End If
                '入金ボタン１回数
                ...
                strSQL02 &= "0,"
                '金額指定回数
                strSQL01 &= "SHITEIKAISU,"
                strSQL02 &= "0,"
                '金額指定合計金額
                strSQL01 &= "SHITEIGOKEIKIN,"
                strSQL02 &= "0,"
                '千円投入回数
    ...
    Private Sub CheckAD1()
        Try
            ...
            If Convert.ToString(_dcAD1.BillState1, 2).PadLeft(8, "0"c).Substring(3, 1).Equals("1") Then
                Me.lblChangeError.Visible = True
            End If
            'なし
    ...
    Private Sub CheckCM()
        Try
            ...
            'つり銭確認
            If Not Me.lblChangeError.Visible Then
...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSlotTest.Click
        Try
            Me.Cursor = Cursors.WaitCursor
    ...
    'Private Sub btnCharge_MouseDown(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles btnCharge.MouseDown, btnCardDispenser.MouseDown, btnCheckIn.MouseDown, btnInfo.MouseDown
    '    Dim pic As PictureBox
    '    pic = CType(sender, PictureBox)
    '    _drwPoint = pic.Location
    '    frmBase.PushAnimation(CType(sender, Control))
    'End Sub

    'Private Sub btnCardDispenser_MouseUp(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles btnCharge.MouseUp, btnCardDispenser.MouseUp, btnCheckIn.MouseUp, btnInfo.MouseUp
    '    frmBase.PushAnimation(CType(sender, Control), _drwPoint)
    'End Sub
