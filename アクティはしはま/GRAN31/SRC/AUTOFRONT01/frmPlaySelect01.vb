...
#Region "▼プロパティ"
    ...
    ''' <value></value>
    ''' <remarks></remarks>
    Public WriteOnly Property BallKin1F As Integer
        Set(value As Integer)
            _intBallKin1F = value
        End Set
    End Property
    Private _intBallKin1F As Integer = 0
    ...
    ''' <value></value>
    ''' <remarks></remarks>
    Public WriteOnly Property BallKin2F As Integer
        Set(value As Integer)
            _intBallKin2F = value
        End Set
    End Property
    Private _intBallKin2F As Integer = 0
...
#Region "▼イベント定義"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub btnTama_Click(sender As System.Object, e As System.EventArgs) Handles btnTama.Click, lblBallKin.Click
        Try
...
#Region "▼関数定義"
    ...
    Private Sub Init()
        Try
            ...
            End If
            Me.lblBallKin.Text = (_intBallKin1F + UIFunction.GetTaxTanka(_intBallKin1F)).ToString & "円(1球)"
