...
#Region "▼イベント定義"
    ...
    Private Sub frmMSGBOX01_Shown(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Shown
        Try
            ...
            frmBase.ChangePictureBoxEnabled(Me.btnCharge, flg2)
...
#End Region
    ...
    Private Sub btnPrintInfo_Click(sender As System.Object, e As System.EventArgs) Handles btnPrintInfo.Click
        Try
            ' 発行日
            ...
            '顧客番号
            _dcSK121.NcsNo = NCSNO
            '氏名
            If Not String.IsNullOrEmpty(CCSNAME) Then
                _dcSK121.Name = CCSNAME & " 様"
            End If
            'カード残高
            _dcSK121.ZanKingaku = CInt(Me.ICR700.KINGAKU)
            'ﾎﾟｲﾝﾄ残高
            _dcSK121.ZanPoint = SRTPO
            '会員期限
            _dcSK121.DMember = DMEMBER


            If Not _dcSK121.PrintCsInfo() Then
                Using frm As New frmMSGBOX01("プリントに失敗しました。", 2)
                    frm.ShowDialog()
                End Using
                Exit Sub
            End If

            frmBase.ChangePictureBoxEnabled(Me.btnPrintInfo, False)
        ...
        Try
            If _dcSK121.GetPrintStatus() Then
                ...
                If _dcSK121.Messages(2).Equals(Techno.DeviceControls.SK121Control.ErrorType.NEAR_END) Then
                    '【紙切れかけ】
                    frmBase.ChangePictureBoxEnabled(Me.btnPrintInfo, True)
                End If
            End If
    ...
    Private Sub btnPrintInfo_MouseDown(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles btnPrintInfo.MouseDown
        _drwPoint = Me.btnPrintInfo.Location
        frmBase.PushAnimation(CType(sender, Control))
    End Sub

    Private Sub btnPrintInfo_MouseUp(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles btnPrintInfo.MouseUp
